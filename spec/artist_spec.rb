...
describe "Artist" do
  ...
  xit "can instantiate a new instance" do
    expect(Artist.new.is_a?(Object)).to eq(true)
  end

  xit "can instantiate with a name, genre, age and hometown" do
  ...
  xit "can be saved to the database" do
    artist.genre = "Electronic"

    expect(artist.save).to eq(true)
  end

  xit "can instantiate and save at the same time with create" do
  ...
  xit "can find an Artist by name" do
  ...
  xit "can roll back to have no favorite_food attribute for Artist" do    
